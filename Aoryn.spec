...
from desktop_agent.version import APP_NAME, APP_PUBLISHER, APP_VERSION
...
for filename in ("README.md", "README.en.md", "config.example.yaml"):
            ...
            [
                StringTable(
                    ...
                    [
                        ...
                        StringStruct("FileDescription", f"{APP_NAME} Desktop App"),
